...
ln={
  ...
  -> "Figure 7.9 of Dov M Gabbay, Cognitive Technologies Reactive Kripke Semantics",
...
ln = {
  ...
  val widgets = List(
    ...
    "Run semantics Level 0" -> steps(e=>e, Semantics, x => Show.toMermaid(x.getLevel0), _.toString, Mermaid),
